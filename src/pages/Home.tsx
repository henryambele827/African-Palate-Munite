...
const CUISINES = [
  {
    name: "Uganda",
    image:
      "https://images.unsplash.com/photo-1604329760661-e71dc83f8f26?auto=format&fit=crop&q=80&w=800",
  },
  {
    name: "Somalia",
    image:
      "https://images.unsplash.com/photo-1666176481173-4c0b1a86cf35?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8U29tYWxpYSUyMGZvb2R8ZW58MHx8MHx8fDA%3D",
  },
  {
    name: "Nigeria",
    image:
  ...
  },
  {
    name: "DR Congo",
    image:
      "https://images.unsplash.com/photo-1518492104633-130d0cc84637?auto=format&fit=crop&q=80&w=800",
  },
  {
    name: "Eritrea",
    image:
  ...
  },
  {
    name: "Tanzania",
    image:
      "https://plus.unsplash.com/premium_photo-1664360227457-e557c4d7f0e6?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mjl8fFRhbnphbmlhJTIwZm9vZHxlbnwwfHwwfHx8MA%3D%3D",
  },
  {
    name: "Rwanda",
    image:
  ...
  },
  {
    name: "Ghana",
    image:
      "https://images.unsplash.com/photo-1705088293220-c1a22b5d214a?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8Z2hhbmElMjBmb29kfGVufDB8fDB8fHww",
  },
  {
    name: "Senegal",
    image:
  ...
  },
  {
    name: "South Africa",
    image:
      "https://images.unsplash.com/photo-1661312220526-1dffbc8ac19f?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTR8fHNvdXRoJTIwYWZyaWNhJTIwZm9vZHxlbnwwfHwwfHx8MA%3D%3D",
  },
  {
    name: "Morocco",
    image:
      "https://images.unsplash.com/photo-1517314597476-e1788060b6cb?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTF8fG1vcm9jY28lMjBmb29kfGVufDB8fDB8fHww",
  },
  {
    name: "Egypt",
    image:
...
const STEPS = [
  {
    icon: Globe2,
    title: "Explore Menu",
    text: "Browse our diverse collection of 36+ cross-continental dishes.",
  },
  {
    icon: Truck,
    title: "Pre-Order",
    text: "Confirm your meal for tomorrow to ensure fresh campus delivery.",
  },
  {
    icon: Heart,
    title: "Enjoy",
    text: "Receive your hot meal at your campus or hostel, prepared with love.",
  },
];
...
const PILLARS = [
  {
    ...
    text: "Every brand is reviewed before going live.",
  },
  {
    icon: Sparkles,
    title: "Fresh Daily",
    text: "Pre-orders mean we cook what you actually ordered.",
  },
  {
    icon: Truck,
    title: "Campus Delivery",
    text: "Hot meals to your hostel, on time, every time.",
  },
];
...
export default function Home() {
  ...
  return (
    <div className="bg-white overflow-hidden">
      ...
      <section className="  -mt-[88px] min-h-[100vh] flex items-center pt-32 pb-16 overflow-hidden text-white">
        {/* Background image */}
          ...
          <div className="max-w-4xl">
            ...
            >
              ...
              <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-xl border border-white/20 text-white px-4 py-2 rounded-full">
                <Sparkles
                  size={14}
                  className="animate-pulse text-brand-yellow"
                />
